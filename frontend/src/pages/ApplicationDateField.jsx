...
export default function ApplicationDateField() {
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-slate-700 mb-1.5">{t("applicationDate")}</label>
      <input
        type="text"
        value={today}
        readOnly
        className="w-full border border-slate-200 rounded px-3 py-2 bg-slate-50 text-slate-500 cursor-not-allowed"
      />
    </div>
  );
}
